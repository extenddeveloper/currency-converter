const UI = {
    ...
    getCountryList(){
        ...
        if(!localStorage.getItem('country-list')){
            ...
            document.addEventListener('DOMContentLoaded', function(){
                ...
                fetch(`https://free.currconv.com/api/v7/convert?q=${selected}_${converTo}&compact=ultra&apiKey=20b2a9a3ec5560b2b345`)
                .then(response => response.json())
                .then(response => {
    ...
    changeCurrencyValue(){
        ...
        getInputCurrency.addEventListener('keyup', function(){
            let selected = selectedCountry.options[selectedCountry.selectedIndex].value;
            let converTo = convertedCountry.options[convertedCountry.selectedIndex].value;
            fetch(`https://free.currconv.com/api/v7/convert?q=${converTo}_${selected}&compact=ultra&apiKey=20b2a9a3ec5560b2b345`)
            .then(response => response.json())
            .then(response => {
                let currVal = Object.values(response);
